...
\ : t<< ( u -- )
\   \ slli t0, t0, ?
\   \ -> ~000000~​{{{shamt(??????)}}} {{{rs1(00101)}}} {{{fn3(001)}}} {{{rd(00101)}}} {{{op(0010011)}}}
\   \ -> 0??29293
\   [ >t ^ ]                                                  \ u@t0 = [s3++8]  ( -- )
\   [ 93 92 42 01 :: ]                                        \ high@t0 = u@t0 << 20                     slli t0, t0, 20
\   [ 37 33 29 29 :: ]					    \ low@t1 = 0x29293                         lui t1, 0x29293
\   [ 13 53 C3 00 :: ]					    \                                          srli t1, t1, 12
\   [ B3 E2 62 00 :: ]				            \ slli@t0 = high@t0 | low@t1               or t0, t0, t1
\   [ v t> ] ` ;                                              \ [s1++4] = "slli ..."                     ---

\ : t| ( u -- )
\   \ ori t0, t0, 0x???
\   \ -> {{{imm(0x???)}}} {{{rs1(00101)}}} {{{fn3(110)}}} {{{rd(00101)}}} {{{op(0010011)}}}
\   \ -> ???2E293
\   [ >t ^ ]                                                  \ u@t0 = [s3++8]  ( -- )                   ---
\   [ 14 t<< ]                                                \ high@t0 = u@t0 << 20  ( -- )             ---
\   [ 37 33 29 2E :: ]					    \ low@t1 = 0x2E293                         lui t1, 0x2E293
\   [ 13 53 C3 00 :: ]					    \                                          srli t1, t1, 12
\   [ B3 E2 62 00 :: ]					    \ ori@t0 = high@t0 | low@t1                or t0, t0, t1
\   [ v t> ] ` ;						    \ [s1++4] = "ori ..."                      ---
