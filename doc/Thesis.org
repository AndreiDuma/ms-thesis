...
| {{{c(2)}}}​~OUTPUT@s1 += 0x0F;~                                      | *addi* s1, s1, /0x00F/ | {{{imm(0x00F)}}}                    {{{rs1(01001)}}} {{{fn3(000)}}} {{{rd(01001)}}}  {{{op(0010011)}}} | {{{addr(12A)}}} | ~93 84 F4 00~                |
| {{{c(2)}}}​~OUTPUT@s1 &= 0xF0;~                                      | *andi* s1, s1, /0x0F0/ | {{{imm(0x0F0)}}}                    {{{rs1(01001)}}} {{{fn3(111)}}} {{{rd(01001)}}}  {{{op(0010011)}}} |                 | ~93 F4 04 0F~                |
|                                                                     |                        |                                                                                                        |                 |                              |
...
| {{{c(2)}}}​~[xt@t0 + 8] ← latest@a0;~                                | *sd* a0, _8_​(t0)       | {{{off(0000000)}}} {{{rs2(01011)}}} {{{rs1(00101)}}} {{{fn3(011)}}} {{{off(01000)}}} {{{op(0100011)}}} |                 | ~23 B4 B2 00~                |
| {{{c(2)}}}​~[LATEST] ← xt@t0;~                                       | *sd* t0, _40_​(s2)      | {{{off(0000001)}}} {{{rs2(00101)}}} {{{rs1(01010)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} |                 | ~23 30 55 02~                |
|                                                                     |                        |                                                                                                        |                 |                              |
...
| ~_begin:~                                                           |                        |                                                                                                        | {{{addr(00)}}}  |                              |
| {{{c(2)}}}​~chr@t2 ← [INPUT@s0++];~                                  | *lb* t2, _0_​(s0)       | {{{off(0x000)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(00111)}}}  {{{op(0000011)}}} |                 | ~83 03 04 00~                |
|                                                                     | *addi* s0, s0, /1/     | {{{imm(0x001)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}}  {{{op(0010011)}}} |                 | ~13 04 14 00~                |
| {{{c(2)}}}​~[OUTPUT@s1] ← chr@t2;~                                   | *sb* t2, _0_​(s1)       | {{{off(0000000)}}} {{{rs2(00111)}}} {{{rs1(01001)}}} {{{fn3(000)}}} {{{off(00000)}}} {{{op(0100011)}}} |                 | ~43 80 74 00~                |
...
| {{{c(2)}}}​~[xt@t0 + 0] ← INPUT@s0;~                                 | *sd* s0, _0_​(t0)       | {{{off(0000000)}}} {{{rs2(01000)}}} {{{rs1(00101)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} |                 | ~43 B0 82 00~                |
|                                                                     |                        |                                                                                                        |                 |                              |
| {{{c(2)}}}​/# 1-bit align ~INPUT~ as required/                       |                        |                                                                                                        |                 |                              |
| {{{c(2)}}}​/# by the RISC-V specification [cite:@riscv_spec_vol_i]./ |                        |                                                                                                        |                 |                              |
| {{{c(2)}}}​~INPUT@s0 += 0x01;~                                       | *addi* s0, s0, /0x001/ | {{{imm(0x001)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}}  {{{op(0010011)}}} |                 | ~13 04 14 00~                |
| {{{c(2)}}}​~INPUT@s0 &= 0xFE;~                                       | *andi* s0, s0, /0x0FE/ | {{{imm(0x0FE)}}}                    {{{rs1(01000)}}} {{{fn3(111)}}} {{{rd(01000)}}}  {{{op(0010011)}}} |                 | ~13 74 E4 0F~                |
| {{{c(2)}}}​~return.~  /# To interpreter loop./                       | *jalr* zero, _0_​(ra)   | {{{off(0x000)}}}                    {{{rs1(00001)}}} {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1101111)}}} |                 | ~6F 80 00 00~                |
