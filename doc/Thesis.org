...
| {{{c(2)}}}​~OUTPUT@s1 += 0x00F;~  /# TODO: Necessary?!               | *addi* s1, s1, /0x00F/                 | {{{imm(0x00F)}}}                    {{{rs1(01001)}}} {{{fn3(000)}}} {{{rd(01001)}}}  {{{op(0010011)}}} | {{{addr(12A)}}} | ~93 84 F4 00~                |
...
| {{{c(2)}}}​~if length@t1 != 0:~                                      |                                        |                                                                                                        |                 |                              |
| {{{c(4)}}}​  ~goto _begin;~                                          | *bne* t1, zero, _0xEC_                 | {{{off(1111111)}}} {{{rs2(00000)}}} {{{rs1(00110)}}} {{{fn3(001)}}} {{{off(01101)}}} {{{op(1100011)}}} | {{{addr(15E)}}} | ~E3 16 03 FE~                |
|                                                                     |                                        |                                                                                                        |                 |                              |
| {{{c(2)}}}​/# 4a. 1-bit align ~INPUT~ as required/                   |                                        |                                                                                                        |                 |                              |
...
| {{{c(2)}}}​~[xt@t0 + 0] ← INPUT@s0;~                                 | *sd* s0, _0_​(t0)                       | {{{off(0000000)}}} {{{rs2(01000)}}} {{{rs1(00101)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} |                 | ~23 B0 82 00~                |
...
| /# Dump memory range ~[addr, addr+u)~./                              |                         |                                                                                                           |                      |                              |
|                                                                      |                         |                                                                                                           |                      |                              |
| {{{i(1)}}} /# Save ~addr~ and ~u~, since they/                       |                         |                                                                                                           |                      |                              |
| {{{i(1)}}} /# will not be preserved across/                          |                         |                                                                                                           |                      |                              |
| {{{i(1)}}} /# the ~write~ system call [cite:@system_v_psabi_riscv]./ |                         |                                                                                                           |                      |                              |
| {{{i(1)}}} ~addr@t1 ← addr@a0;~                                      | *addi* t1, a0, 0        | {{{imm(0x00.0)}}}                    {{{rs1(0101.0)}}} {{{fn3(000)}}} {{{rd(0011.0)}}}  {{{op(0010011)}}} |                      | ~13 03 05 00~                |
| {{{i(1)}}} ~u@t2 ← u@a1;~                                            | *addi* t2, a1, 0        | {{{imm(0x00.0)}}}                    {{{rs1(0101.1)}}} {{{fn3(000)}}} {{{rd(0011.1)}}}  {{{op(0010011)}}} |                      | ~93 83 05 00~                |
| ~_begin:~                                                            |                         |                                                                                                           | {{{addr(00)}}}[fn:2] |                              |
| {{{i(1)}}} ~fd@a0 ← 1;~  /# ~STDOUT_FILENO~./                        | *addi* a0, zero, 1      | {{{imm(0x00.1)}}}                    {{{rs1(0000.0)}}} {{{fn3(000)}}} {{{rd(0101.0)}}}  {{{op(0010011)}}} |                      | ~13 05 10 00~                |
| {{{i(1)}}} ~addr@a1 ← addr@t1;~                                      | *addi* a1, t1, 0        | {{{imm(0x00.0)}}}                    {{{rs1(0011.0)}}} {{{fn3(000)}}} {{{rd(0101.1)}}}  {{{op(0010011)}}} |                      | ~93 05 03 00~                |
| {{{i(1)}}} ~u@a2 ← u@t2;~                                            | *addi* a2, t2, 0        | {{{imm(0x00.0)}}}                    {{{rs1(0011.1)}}} {{{fn3(000)}}} {{{rd(0110.0)}}}  {{{op(0010011)}}} |                      | ~13 86 03 00~                |
...
| {{{i(1)}}} ~addr@t0 += ret@a0;~                                      | *add* t0, t0, a0        | {{{fn7(0000000)}}} {{{rs2(0.1010)}}} {{{rs1(0010.1)}}} {{{fn3(000)}}} {{{rd(0010.1)}}}  {{{op(0110011)}}} |                      | ~B3 82 A2 00~                |
| {{{i(1)}}} /# Fewer bytes left to print./                            |                         |                                                                                                           |                      |                              |
| {{{i(1)}}} ~u@t1 -= ret@a0;~                                         | *sub* t1, t1, a0        | {{{fn7(0100000)}}} {{{rs2(0.1010)}}} {{{rs1(0011.0)}}} {{{fn3(000)}}} {{{rd(0011.0)}}}  {{{op(0110011)}}} |                      | ~33 03 A3 40~                |
| {{{i(1)}}} ~if u@t1 > 0:~                                            |                         |                                                                                                           |                      |                              |
| {{{i(2)}}}     /# We still have bytes to print./                     |                         |                                                                                                           |                      |                              |
| {{{i(2)}}}     ~goto _begin.~                                        | *blt* zero, t1, _-0x20_ | {{{off(1111111)}}} {{{rs2(0.0110)}}} {{{rs1(0000.0)}}} {{{fn3(100)}}} {{{off(0000.1)}}} {{{op(1100011)}}} | {{{addr(20)}}}       | ~E3 40 60 FE~                |
| ~_end:~                                                              |                         |                                                                                                           | {{{addr(24)}}}       |                              |
