...
|                                                                                       | addi t0, t0, 0x100 | {{{imm(0x100)}}}                    {{{rs1(00101)}}} {{{fn3(000)}}} {{{rd(00101)}}}  {{{op(0010011)}}} | ~93 82 02 10~       |
| ~[OUTPUT@s1 + 4] ← t0;~                                                               | sd t0, 0(s1)       | {{{off(0000000)}}} {{{rs2(00101)}}} {{{rs1(01001)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} | ~23 B0 54 00~       |
|                                                                                       |                    |                                                                                                        |                     |
| /# 3. Assemble and write ~jalr~./                                                     |                    |                                                                                                        |                     |
| ~t0 ← 0x67800000;~                                                                    | lui t0, 0x67800    | {{{imm(0x67800)}}}                                                  {{{rd(00101)}}}  {{{op(0110111)}}} | ~B7 02 80 67~       |
| ~[OUTPUT@s1 + 8] ← t0;~                                                               | sd t0, 0(s1)       | {{{off(0000000)}}} {{{rs2(00101)}}} {{{rs1(01001)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} | ~23 B0 54 00~       |
