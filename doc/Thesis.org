...
| {{{i(1)}}} ~if chr@t0 = [xt@s3 + 17]:~            | ~lb t1,0x011(a0)~     | {{{off(0x011)}}}                    {{{rs1(01010)}}} {{{fn3(000)}}} {{{rd(00110)}}} {{{op(0000011)}}}  |                |                |
...
| {{{i(1)}}} /# to previous entry and repeat./      |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~xt@a0 ← [xt@a0 + 8];~                 | ~ld s3,8(s3)~         | {{{off(0x008)}}}                    {{{rs1(01010)}}} {{{fn3(011)}}} {{{rd(01010)}}} {{{op(0000011)}}}  |                |                |
...
|                                            |                         |          |                |                                         |
| /# 2. Set the _flag+length field_./        |                         |          |                |                                         |
| ~OUTPUT@s1 += 0x10;~                       | TODO: remove            |          |                | ~48 83~ {{{modrm(C7,11,000,111)}}} ~10~ |
| ~[OUTPUT@RDI++] ← flag@AL;~                | TODO: remove            |          |                | ~AA~                                    |
| ~[OUTPUT@s1+16] ← flag@a1;~                | sb a1, 16(s1)           |          |                |                                         |
|                                            |                         |          |                |                                         |
| /# 3. Extract name length from flag/       |                         |          |                |                                         |
| /#{{{c(3)}}}and copy _name field_./        |                         |          |                |                                         |
| ~flag@ECX ← flag@AL;~                      | TODO: remove            |          |                | ~91~                                    |
| ~length@t0 ← flag@a1 & 0x1F;~              | andi t0, a1, 0x01F      |          |                | ~83~ {{{modrm(E1,11,100,001)}}} ~1F~    |
