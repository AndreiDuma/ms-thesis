...
| ~_bi:~                                            |                         |                                                                                                        | {{{addr(90)}}} |                |
| {{{i(1)}}} /# Loop the binary interpreter./       |                         |                                                                                                        |                |                |
| {{{i(1)}}} ~call bi();~                           | *jalr* ra, 8(zero)      | {{{off(0x008)}}}                    {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00001)}}}  {{{op(1101111)}}} |                | ~EF 00 80 00~  |
| {{{i(1)}}} ~goto _bi.~                            | *jalr* zero, -8(zero)   | {{{off(0xFF8)}}}                    {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1101111)}}} |                | ~6F 00 80 FF~  |
| ~bi():~                                           |                         |                                                                                                        | {{{addr(98)}}} |                |
| {{{i(1)}}} /# Read next byte from ~INPUT~./       |                         |                                                                                                        |                |                |
| {{{i(1)}}} ~chr@t0 ← [INPUT@s0++];~               | *lb* t0, s0, 0          | {{{off(0x000)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(00101)}}}  {{{op(0000011)}}} |                | ~83 02 04 00~  |
...
| {{{i(1)}}} ~return.~                              | *jalr* zero, 0(ra)      | {{{off(0x000)}}}                    {{{rs1(00001)}}} {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1101111)}}} |                | ~6F 80 00 00~  |
| ~_command:~                                       |                         |                                                                                                        | {{{addr(B4)}}} |                |
| {{{i(1)}}} /# Get latest dictionary word/         |                         |                                                                                                        |                |                |
| {{{i(1)}}} /# from ~LATEST~ (~VARS + 40~):/       |                         |                                                                                                        |                |                |
| {{{i(1)}}} ~xt@a0 ← [LATEST];~                    | *ld* a0, 40(s2)         | {{{off(0x028)}}}                    {{{rs1(01010)}}} {{{fn3(011)}}} {{{rd(01010)}}}  {{{op(0000011)}}} |                | ~03 35 85 02~  |
| {{{i(1)}}}                                        |                         |                                                                                                        |                |                |
| {{{i(1)}}} /# Read command argument./             |                         |                                                                                                        |                |                |
| {{{i(1)}}} ~arg@a1 ← [INPUT@s0++];~               | *lb* a1, s0, 0          | {{{off(0x000)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01011)}}}  {{{op(0000011)}}} |                | ~83 05 04 00~  |
| {{{i(1)}}}                                        | *addi* s0, s0, 1        | {{{imm(0x001)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}}  {{{op(0010011)}}} |                | ~13 04 A0 00~  |
| {{{i(1)}}} /# Command type by argument:/          |                         |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0bi00ccccc~: define;/            |                         |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0b011ccccc~: compile;/           |                         |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0b111ccccc~: execute./           |                         |                                                                                                        |                |                |
...
| {{{i(2)}}}     /# _Define_ a new word./           |                         |                                                                                                        |                |                |
| {{{i(2)}}}     ~goto Head.~                       | *beq* t0, zero, _0x068_ | {{{off(0000011)}}} {{{rs2(00000)}}} {{{rs1(00101)}}} {{{fn3(000)}}} {{{off(00110)}}} {{{op(1100011)}}} | {{{addr(C4)}}} | ~63 83 02 06~  |
| ~_find1:~                                         |                         |                                                                                                        | {{{addr(C8)}}} |                |
| {{{i(1)}}} ~chr@t0~ ~←~ ~arg@a1~ ~&~ ~0b0111111;~ | *andi* t0, a1, 0x07F    | {{{imm(0x07F)}}}                    {{{rs1(01011)}}} {{{fn3(111)}}} {{{rd(00101)}}}  {{{op(0010011)}}} |                | ~93 F2 F5 07~  |
| {{{i(1)}}} ~if chr@t0 = [xt@a0 + 17]:~            | *lb* t1, 0x011(a0)      | {{{off(0x011)}}}                    {{{rs1(01010)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0000011)}}} |                | ~03 03 15 01~  |
...
| {{{i(1)}}} ~goto _find1.~                         | *jalr* zero, _0xFF0_    | {{{off(0xFF0)}}}                    {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1101111)}}} | {{{addr(D8)}}} | ~6F 00 00 FF~  |
| ~_match:~                                         |                         |                                                                                                        | {{{addr(DC)}}} |                |
...
| {{{i(1)}}} ~goto [xt@a0].~                        | *ld* t0, 0(a0)          | {{{off(0x000)}}}                    {{{rs1(01010)}}} {{{fn3(011)}}} {{{rd(00101)}}}  {{{op(0000011)}}} | {{{addr(E4)}}} | ~32 83 05 00~  |
| {{{i(1)}}}                                        | *jalr* zero, 0(t0)      | {{{off(0x000)}}}                    {{{rs1(00101)}}} {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1101111)}}} |                | ~6F 80 02 00~  |
|                                                   |                         |                                                                                                        | {{{addr(EC)}}} |                |
...
| ~t0 ← [xt@a0];~                                                                                | *lw* t0, 0(a0)       | {{{off(0x000)}}}                    {{{rs1(01010)}}} {{{fn3(010)}}} {{{rd(00101)}}}  {{{op(0000011)}}} | {{{addr(F4)}}}  | ~83 22 05 00~                   |
|                                                                                                |                      |                                                                                                        |                 |                                 |
...
|                                                                                                | *addi* s1, s1, 4     | {{{imm(0x004)}}}                    {{{rs1(00110)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                 | ~13 03 43 00~                   |
...
| ~t0 <<= 20;~                                                                                   | *slli* t0, t0, 20    | ~000000~ {{{shamt(010100)}}}        {{{rs1(00101)}}} {{{fn3(101)}}} {{{rd(00101)}}}  {{{op(0010011)}}} |                 | ~93 D2 42 01~                   |
| ~t1~ \vert​~= t0;~                                                                                  | *or* t1, t1, t0      | {{{fn7(0000000)}}} {{{rs2(00101)}}} {{{rs1(00110)}}} {{{fn3(110)}}} {{{rd(00110)}}}  {{{op(0110011)}}} |                 | ~33 63 53 00~                   |
| ~[OUTPUT@s1++4] ← t1;~                                                                         | *sw* t1, 0(s1)       | {{{off(0000000)}}} {{{rs2(00110)}}} {{{rs1(01001)}}} {{{fn3(010)}}} {{{off(00000)}}} {{{op(0100011)}}} |                 | ~23 A0 64 00~                   |
|                                                                                                | *addi* s1, s1, 4     | {{{imm(0x004)}}}                    {{{rs1(00110)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                 | ~13 03 43 00~                   |
| ~return.~  /# To interpreter loop./                                                            | *jalr* zero, 0(ra)   | {{{off(0x000)}}}                    {{{rs1(00001)}}} {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1101111)}}} |                 | ~6F 80 00 00~                   |
|                                                                                                |                      |                                                                                                        | {{{addr(124)}}} |                                 |
...
| *Pseudocode*                                                        | *Instruction*          | *Encoding*                                                                                             | *&*             | *Machine code*               |
|---------------------------------------------------------------------+------------------------+--------------------------------------------------------------------------------------------------------+-----------------+------------------------------|
| /# Define:/ _~Head~_                                                | ---                    | ---                                                                                                    | {{{addr(124)}}} | {{{define(04,48 65 61 64)}}} |
| /# In/Out:/ ~( latest@a0~                                           |                        |                                                                                                        |                 |                              |
| /#/{{{io}}}   ~flag@a1 -​- )~                                        |                        |                                                                                                        |                 |                              |
|                                                                     |                        |                                                                                                        |                 |                              |
| {{{c(2)}}}​/# 16-bit align ~OUTPUT~./                                |                        |                                                                                                        |                 |                              |
| {{{c(2)}}}​~OUTPUT@s1 += 0x0F;~                                      | *addi* s1, s1, /0x00F/ | {{{imm(0x00F)}}}                    {{{rs1(01001)}}} {{{fn3(000)}}} {{{rd(01001)}}}  {{{op(0010011)}}} | {{{addr(12A)}}} | ~~                           |
...
| {{{c(2)}}}​~if length@t1 != 0:~                                      |                        |                                                                                                        |                 |                              |
| {{{c(4)}}}​  ~goto _begin;~                                          | *bne* t1, zero, _-??_  | {{{off(bbbbbbb)}}} {{{rs2(00000)}}} {{{rs1(00110)}}} {{{fn3(001)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} | {{{addr(14)}}}  | ~~                           |
|                                                                     |                        |                                                                                                        |                 |                              |
