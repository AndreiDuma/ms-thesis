...
| ~[OUTPUT@s1] ← t0;~                                                                   | sd t0, 0(s1)       | {{{off(0000000)}}} {{{rs2(00101)}}} {{{rs1(01001)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} | ~23 B0 54 00~       |
|                                                                                       |                    |                                                                                                        |                     |
...
| ~[OUTPUT@s1 + 4] ← t0;~                                                               | sd t0, 4(s1)       | {{{off(0000000)}}} {{{rs2(00101)}}} {{{rs1(01001)}}} {{{fn3(011)}}} {{{off(00100)}}} {{{op(0100011)}}} | ~23 B2 54 00~       |
...
| /# – encoded:/ {{{off(0x000)}}} {{{rs1(00010)}}}                                      |                    |                                                                                                        |                     |
| /#/{{{i(5.1)}}} \(\hookrightarrow\) {{{fn3(000)}}} {{{rd(00001)}}}  {{{op(0000011)}}} |                    |                                                                                                        |                     |
| /# 2. Deallocate stack space:/                                                        |                    |                                                                                                        |                     |
| /# – instruction:/ ~addi sp, sp, 8~                                                   |                    |                                                                                                        |                     |
| /# – encoded:/ {{{imm(0x008)}}} {{{rs1(00010)}}}                                      |                    |                                                                                                        |                     |
| /#/{{{i(5.1)}}} \(\hookrightarrow\) {{{fn3(000)}}} {{{rd(00010)}}}  {{{op(0010011)}}} |                    |                                                                                                        |                     |
| /# 3. Return to calling word:/                                                        |                    |                                                                                                        |                     |
| /# – instruction:/ ~jalr zero, 0(ra)~                                                 |                    |                                                                                                        |                     |
| /# – encoded:/ {{{off(0x000)}}} {{{rs1(00001)}}}                                      |                    |                                                                                                        |                     |
| /#/{{{i(5.1)}}} \(\hookrightarrow\) {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1100111)}}} |                    |                                                                                                        |                     |
| /#/                                                                                   |                    |                                                                                                        |                     |
| /# Thus we generate code as follows:/                                                 |                    |                                                                                                        |                     |
| /#/{{{c(2)}}}​~0x83·00·01·00~                                                          |                    |                                                                                                        |                     |
| /#/{{{c(2)}}}​~0x13·01·81·00~                                                          |                    |                                                                                                        |                     |
...
| ~t0 ← 0x83000100;~                                                                    | lui t0, 0x83000    |                                                                                                        |                     |
|                                                                                       | addi t0, t0, 0x100 |                                                                                                        |                     |
| ~[OUTPUT@s1] ← t0;~                                                                   | sd t0, 0(s1)       | {{{off(0000000)}}} {{{rs2(00101)}}} {{{rs1(01001)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} | ~23 B0 54 00~       |
|                                                                                       |                    |                                                                                                        |                     |
| /# 2. Assemble and write ~addi~./                                                     |                    |                                                                                                        |                     |
| ~t0 ← 0x13018100;~                                                                    | lui t0, 0x13018    |                                                                                                        |                     |
|                                                                                       | addi t0, t0, 0x100 |                                                                                                        |                     |
| ~[OUTPUT@s1 + 4] ← t0;~                                                               | sd t0, 0(s1)       |                                                                                                        |                     |
|                                                                                       |                    |                                                                                                        |                     |
| /# 3. Assemble and write ~jalr~./                                                     |                    |                                                                                                        |                     |
| ~t0 ← 0x67800000;~                                                                    | lui t0, 0x67800    |                                                                                                        |                     |
| ~[OUTPUT@s1 + 8] ← t0;~                                                               | sd t0, 0(s1)       |                                                                                                        |                     |
| ~OUTPUT@s1 += 12;~                                                                    | addi s1, s1, 12    |                                                                                                        |                     |
|                                                                                       |                    |                                                                                                        |                     |
| /# Clear the ~HIDDEN~ bit (~0x40~) on/                                                |                    |                                                                                                        |                     |
| /# the dictionary entry's flag./                                                      |                    |                                                                                                        |                     |
| ~xt@t0 ← [LATEST];~                                                                   | ld t0, 40(s2)      | {{{off(0x028)}}}                    {{{rs1(10010)}}} {{{fn3(011)}}} {{{rd(00101)}}}  {{{op(0000011)}}} | ~83 32 89 02~       |
| ~flag@t1 ← [xt@t0 + 16];~                                                             | lbu t1, 16(t0)     | {{{off(0x010)}}}                    {{{rs1(00101)}}} {{{fn3(100)}}} {{{rd(00110)}}}  {{{op(0000011)}}} | ~03 C3 02 01~       |
| ~flag@t1 &= 0b10111111;~  /# =~HIDDEN=.                                               |                    |                                                                                                        |                     |
| ~[xt@t0 + 16] ← flag@t1;~                                                             | sb t1, 16(t0)      | {{{off(0000000)}}} {{{rs2(00110)}}} {{{rs1(00101)}}} {{{fn3(000)}}} {{{off(10000)}}} {{{op(0100011)}}} | ~23 88 62 00~       |
|                                                                                       |                    |                                                                                                        |                     |
| /# Switch to interpreting state./                                                     |                    |                                                                                                        |                     |
