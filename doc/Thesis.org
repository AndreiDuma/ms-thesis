...
Citations:
- Alpine [cite:@linux_alpine]
- Alpine/Docker/AMD64 [cite:@linux_alpine_docker_amd64]
- Alpine/Docker/RISC-V [cite:@linux_alpine_docker_riscv]

*** Docker
#+begin_src sh
  # Run factory Alpine image.
  docker run --platform 'linux/riscv64'  \
	     --volume /Users/andrei/dev/AndreiDuma/ms-thesis/:/forth/  \
	     -it 'riscv64/alpine:3.20.2'

  # Build.
  docker build --platform 'linux/riscv64' -t 'riscv' .
#+end_src
