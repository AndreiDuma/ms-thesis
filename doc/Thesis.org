...
| {{{i(1)}}} /# {{{i(2.35)}}} ~TIB~ is ~VARS+8~,/  |                     |            |                |                                    |
| {{{i(1)}}} /# {{{i(2.35)}}} ~>IN~ is ~VARS+16~./ |                     |            |                |                                    |
| {{{i(1)}}} ~#in@t0 ← [#IN];~                     | ld t0, 0(s2)        |            |                | ~~                                 |
| {{{i(1)}}} ~tib@t1 ← [TIB] + #in@t0;~            | ld t1, 8(s2)        |            |                | ~~                                 |
| {{{i(1)}}}                                       | add t1, t1, t0      |            |                | ~~                                 |
| {{{i(1)}}} ~[TIB] ← tib@t1;~                     | sd t1, 8(s2)        |            |                | ~~                                 |
| {{{i(1)}}}                                       |                     |            |                |                                    |
| {{{i(1)}}} /# Reset ~#IN~ and ~>IN~ to 0./       |                     |            |                |                                    |
| {{{i(1)}}} ~#in@t0 &= 0;~                        | addi t0, zero, 0    |            |                | ~~                                 |
| {{{i(1)}}} ~[>IN] &= 0;~                         | sd zero, 16(s2)     |            |                | ~~                                 |
| {{{i(1)}}}                                       |                     |            |                |                                    |
| {{{i(1)}}} /# Advance ~#IN~ until just/          |                     |            |                |                                    |
| {{{i(1)}}} /# after first ~LF~ character./       |                     |            |                |                                    |
| ~_begin:~                                        |                     |            | {{{addr(00)}}} |                                    |
| {{{i(1)}}} ~#in@t0++;~                           | addi t0, t0, 1      |            |                | ~~                                 |
| {{{i(1)}}} ~chr@t3 ← [tib@t1 + #in@t0 - 1];~     | add t2, t1, t0      |            |                | ~~                                 |
| {{{i(1)}}}                                       | lbu t3, -1(t2)      |            |                | ~~                                 |
| {{{i(1)}}} /# Newline character?/                |                     |            |                |                                    |
| {{{i(1)}}} ~if chr != 0x0A:~                     | addi t4, zero, 0x0A |            |                | ~~                                 |
| {{{i(2)}}}   ~goto _begin.~                      | bne t3, t4, -??     |            | {{{addr(10)}}} | ~~                                 |
| {{{i(1)}}}                                       |                     |            |                |                                    |
| {{{i(1)}}} /# Store the new ~#IN~./              |                     |            |                |                                    |
| {{{i(1)}}} ~[#IN] ← #in@t0;~                     | sd t0, 0(s2)        |            |                | ~~                                 |
| {{{i(1)}}} ~return.~                             | jalr zero, 0(ra)    |            |                | ~~                                 |
...
|                                                  |                  |            |                |                              |
| {{{c(2)}}} ~eof@a0 ← 0;~                         | addi a0, zero, 0 |            |                | ~~                           |
| {{{c(2)}}} ~high'@a1 ← high@a1~                  |                  |            |                |                              |
| {{{c(11)}}}         ~- low@a0;~                  | sub a1, a1, a0   |            |                | ~~                           |
| ~_begin:~                                        |                  |            | {{{addr(00)}}} |                              |
| {{{c(2)}}} /# Is parse area empty?/              |                  |            |                |                              |
| {{{c(2)}}} ~>in@t2 ← [>IN];~                     | ld t2, 16(s2)    |            |                | ~~                           |
| {{{c(2)}}} ~#in@t0 ← [#IN];~                     | ld t0, 0(s2)     |            |                | ~~                           |
| {{{c(2)}}} ~if >in@t2~ \ge{{{unsigned}}} ~#in@t0:~ |                  |            |                |                              |
| {{{c(4)}}}   ~goto _end.~                        | bgeu t2, t0, +?? |            | {{{addr(08)}}} | ~~                           |
| {{{c(2)}}} /# Get current character./            |                  |            |                |                              |
| {{{c(2)}}} ~tib@t1 ← [TIB];~                     | ld t1, 8(s2)     |            |                | ~~                           |
| {{{c(2)}}} ~chr@t3 ← [tib@t1~                    |                  |            |                |                              |
| {{{c(10)}}}        ~+ >in@t2];~                  | add t4, t1, t2   |            |                | ~~                           |
| {{{c(2)}}}                                       | lbu t3, 0(t4)    |            |                | ~~                           |
| {{{c(2)}}} /# Is ~chr~ in ~[low, high)~?/        |                  |            |                |                              |
| {{{c(2)}}} ~chr'@t3 ← chr@t3~                    |                  |            |                |                              |
| {{{c(10)}}}        ~- low@a0;~                   | sub t3, t3, a0   |            |                | ~~                           |
| {{{c(2)}}} ~if t3~ \lt{{{unsigned}}} ~high'@a1:~   |                  |            |                |                              |
| {{{c(4)}}}   ~goto _end.~                        | bltu t3, a1, +?? |            | {{{addr(1C)}}} | ~~                           |
| {{{c(2)}}} /# Go to next character./             |                  |            |                |                              |
| {{{c(2)}}} ~>in@t2++;~                           | addi t2, t2, 1   |            |                | ~~                           |
| {{{c(2)}}} ~goto _begin.~                        | jal zero, -??    |            | {{{addr(24)}}} | ~~                           |
| ~_end_eof:~                                      |                  |            | {{{addr(28)}}} |                              |
| {{{c(2)}}} ~eof@a0 ← 1;~                         | addi a0, zero, 1 |            |                | ~~                           |
| ~_end:~                                          |                  |            | {{{addr(2C)}}} |                              |
| {{{c(2)}}} ~[>IN] ← >in@t2;~                     | sd t2, 16(s2)    |            |                | ~~                           |
| {{{c(2)}}} ~return.~                             | jalr zero, 0(ra) |            |                | ~~                           |
...
| /# address and length./                         |                   |            |                |                                 |
|                                                 |                   |            |                |                                 |
| {{{c( 2)}}} ~push ra;~                          | addi sp, sp, -16  |            |                | ~~                              |
| {{{c( 2)}}}                                     | sd ra, 8(sp)      |            |                | ~~                              |
| {{{c( 2)}}} ~start@t0 ← [>IN];~                 | ld t0, 16(s2)     |            |                | ~~                              |
| {{{c( 2)}}} ~push start@t0;~                    | sd t0, 0(sp)      |            |                | ~~                              |
| {{{c( 2)}}} /# Compile a call to ~seek~/        |                   |            |                |                                 |
| {{{c( 2)}}} /# that advances ~>IN~./            |                   |            |                |                                 |
| {{{c( 2)}}} ~call seek;~  /# Compiled./         | ---               | ---        |                | {{{compile(73,s)}}}             |
| {{{c( 2)}}} ~end@t1 ← [>IN];~                   | ld t1, 16(s2)     |            |                | ~~                              |
| {{{c( 2)}}} ~restore start@t0;~                 | ld t0, 0(sp)      |            |                | ~~                              |
| {{{c( 2)}}} /# Did ~seek()~ encounter the/      |                   |            |                |                                 |
| {{{c( 2)}}} /# end of the parse area?/          |                   |            |                |                                 |
| {{{c( 2)}}} ~if eof@a0 = 0:~                    |                   |            |                |                                 |
| {{{c( 4)}}}   ~goto _end.~                      | beq t0, zero, +?? |            | {{{addr(00)}}} | ~~                              |
| {{{c( 2)}}} /# A character in range/            |                   |            |                |                                 |
| {{{c( 2)}}} /# ~[low, high)~ was found./        |                   |            |                |                                 |
| {{{c( 2)}}} ~[>IN]++;~  /# Skip it./            | addi t2, t1, 1    |            |                | ~~                              |
| {{{c( 2)}}}                                     | sd t2, 16(s2)     |            |                | ~~                              |
| ~_end:~                                         |                   |            | {{{addr(08)}}} |                                 |
| {{{c( 2)}}} /# Compute address and/             |                   |            |                |                                 |
| {{{c( 2)}}} /# length of parsed input./         |                   |            |                |                                 |
| {{{c( 2)}}} ~u@a0~ ~←~ ~end@t1~ ~-~ ~start@t0;~ | sub a0, t1, t0    |            |                | ~~                              |
| {{{c( 2)}}} ~addr@a1 ← [TIB]~                   | ld t2, 8(s2)      |            |                | ~~                              |
| {{{c(10)}}}         ~+ start@t0;~               | add a1, t2, t0    |            |                | ~~                              |
| {{{c( 2)}}} ~pop ra;~                           | ld ra, 8(sp)      |            |                | ~~                              |
| {{{c( 2)}}}                                     | addi sp, sp, 16   |            |                | ~~                              |
| {{{c( 2)}}} ~return.~                           | jalr zero, 0(ra)  |            |                | ~~                              |
...
| /# parse the word itself./         |                 |            |                                 |
|                                    |                 |            |                                 |
| ~push ra;~                         | addi sp, sp, -8 |            |                                 |
|                                    | sd ra, 0(sp)    |            |                                 |
| /# Skip non-printables./           |                 |            |                                 |
| ~low@a0 ← 0x21;~   /# Char ~'!'~./ |                 |            |                                 |
| ~high@a1 ← 0x7F;~  /# Char ~DEL~./ |                 |            |                                 |
