...
| {{{i(1)}}} /# _Execute_: jump to entry's code./ |                  |               | {{{addr(B0)}}} |                                         |                         |
...
| ~_bi:~                                           |                       |                                                                                                        | {{{addr(90)}}} |                |                         |
| {{{i(1)}}} /# Loop the binary interpreter./      |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~call bi();~                          | ~jalr ra,8(zero)~     | {{{off(0x008)}}} {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00001)}}} {{{op(1101111)}}}                     |                | ~DF 00 80 00~  | call bi()               |
| {{{i(1)}}} ~goto _bi.~                           | ~jalr zero,-8(zero)~  | {{{off(0xFF8)}}} {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00000)}}} {{{op(1101111)}}}                     |                | ~6F 00 80 FF~  | jump _bi                |
| ~bi():~                                          |                       |                                                                                                        | {{{addr(98)}}} |                |                         |
| {{{i(1)}}} /# Read next byte from ~INPUT~./      |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~chr@a1 ← [INPUT@s0++];~              | ~lb a1,s0,0~          | {{{off(0x000)}}} {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01011)}}} {{{op(0000011)}}}                     |                | ~83 05 04 00~  | al = [rsi++]            |
| {{{i(1)}}}                                       | ~addi s0,s0,1~        | {{{imm(0x001)}}} {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}} {{{op(0010011)}}}                     |                | ~13 04 14 00~  |                         |
| {{{i(1)}}} /# Does it start a command?/          |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~if chr@a1 = 0x99:~                   | ~addi t0,zero,0x099~  | {{{imm(0x099)}}} {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00101)}}} {{{op(0010011)}}}                     |                | ~93 02 90 09~  | cmp al, 99(command)     |
| {{{i(2)}}}     ~goto _command.~                  | ~beq a1,t0,+??~       | {{{off(???????)}}} {{{rs2(00101)}}} {{{rs1(01011)}}} {{{fn3(000)}}} {{{off(?????)}}} {{{op(1100011)}}} |                |                | jump _command if ==     |
| {{{i(1)}}} /# If not, just copy the byte/        |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} /# to ~OUTPUT~ and return./           |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~[OUTPUT@s1++] <- chr@a1;~            | ~sb a1,0(s1)~         | {{{off(???????)}}} {{{rs2(01011)}}} {{{rs1(01001)}}} {{{fn3(000)}}} {{{off(?????)}}} {{{op(0100011)}}} |                |                | [rdi++] = al (xmit)     |
| {{{i(1)}}}                                       | ~addi s1,s1,1~        | {{{imm(0x001)}}} {{{rs1(01001)}}} {{{fn3(000)}}} {{{rd(01001)}}} {{{op(0010011)}}}                     |                |                |                         |
| {{{i(1)}}} ~return.~                             | ~jalr zero,0(ra)~     | {{{off(0x000)}}} {{{rs1(00001)}}} {{{fn3(000)}}} {{{rd(00001)}}} {{{op(1101111)}}}                     |                |                | return                  |
| ~_command:~                                      |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} /# Address of global ~LATEST~./       | TODO: remove          |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~LATEST@?? ← 0x10000028;~             | TODO: remove          |                                                                                                        |                |                | rdx = Latest            |
| {{{i(1)}}} /# Read command argument./            |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~arg@a1 ← [INPUT@s0++];~              | ~lb a1,s0,0~          | {{{off(0x000)}}} {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01011)}}} {{{op(0000011)}}}                     |                |                | al = [rsi++] (argument) |
| {{{i(1)}}}                                       | ~addi s0,s0,1~        | {{{imm(0x001)}}} {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}} {{{op(0010011)}}}                     |                |                |                         |
| {{{i(1)}}} /# Command type by argument:/         |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} /# – ~0bx00xxxxx~: define;/           |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} /# – ~0b011xxxxx~: compile;/          |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} /# – ~0b111xxxxx~: execute./          |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~if arg@a1~ ~&~ ~0b01100000~ ~=~ ~0:~ | ~andi t0,a1,0x060~    | {{{imm(0x060)}}} {{{rs1(01011)}}} {{{fn3(111)}}} {{{rd(00101)}}} {{{op(0010011)}}}                     |                |                | al & 60(graphic)?       |
| {{{i(2)}}}     /# _Define_ a new word./          |                       |                                                                                                        |                |                |                         |
| {{{i(2)}}}     ~goto Head.~                      | ~beq t0,zero,+??~     | {{{off(???????)}}} {{{rs2(00000)}}} {{{rs1(00101)}}} {{{fn3(000)}}} {{{off(?????)}}} {{{op(1100011)}}} |                |                | jump Head if zero       |
| {{{i(1)}}} /# Get latest dictionary word/        |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} /# from ~[VARS+40]~:/                 |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~xt@s3 ← [LATEST];~                   | ~ld s3,40(s2)~        | {{{off(0x028)}}} {{{rs1(01010)}}} {{{fn3(011)}}} {{{rd(?????)}}} {{{op(0000011)}}}                     |                |                | rbx = [rdx]             |
| ~_find1:~                                        |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~save arg@AL on the stack;~           | TODO: remove          |                                                                                                        |                |                | push al                 |
| {{{i(1)}}} ~chr@a1 &= 0b0111111;~                | ~andi t0,a1,0x07F~    | {{{imm(0x07F)}}} {{{rs1(01011)}}} {{{fn3(111)}}} {{{rd(00101)}}} {{{op(0010011)}}}                     |                |                | al &= 7F                |
| {{{i(1)}}} ~if char@AL = [xt@s3 + 17]:~          | ~lb t1,0x011(s3)~     | {{{off(0x011)}}} {{{rs1(?????)}}} {{{fn3(000)}}} {{{rd(00110)}}} {{{op(0000011)}}}                     |                |                | cmp al, [rbx+11]        |
| {{{i(2)}}}     /# We found a word whose/         |                       |                                                                                                        |                |                |                         |
| {{{i(2)}}}     /# name begins with ~chr~./       |                       |                                                                                                        |                |                |                         |
| {{{i(2)}}}     ~restore arg@AL;~                 | TODO: remove          |                                                                                                        |                |                | pop al                  |
| {{{i(2)}}}     ~goto _match.~                    | ~beq t0,t1,+??~       |                                                                                                        |                |                | jump _match if ==       |
| {{{i(1)}}} /# Follow word's link pointer/        |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} /# to previous entry and repeat./     |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~entry@s3 ← [xt@s3 + 8];~             | ~ld s3,8(s3)~         |                                                                                                        |                |                | rbx = [rbx+8]           |
| {{{i(1)}}} ~goto _find1.~                        | ~jalr zero,-??(zero)~ |                                                                                                        |                |                | jump _find1             |
| ~_match:~                                        |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~if arg@a1 & 0b1000000 = 0:~          | ~andi t0,a1,0x080~    |                                                                                                        |                |                | al & 80(exec) ?         |
| {{{i(2)}}}     /# _Compile_./                    |                       |                                                                                                        |                |                |                         |
| {{{i(2)}}}     ~goto COMPL.~                     | ~beq t0,zero,+??~     |                                                                                                        |                |                | jump COMPL if zero      |
| {{{i(1)}}} /# _Execute_ word's code./            |                       |                                                                                                        |                |                |                         |
| {{{i(1)}}} ~goto [xt@s3].~                       | ~ld t0,0(s3)~         |                                                                                                        |                |                | jump [rbx] (exec)       |
| {{{i(1)}}}                                       | ~jalr zero,0(t0)~     |                                                                                                        |                |                |                         |
|                                                  |                       |                                                                                                        | {{{addr(??)}}} |                |                         |
