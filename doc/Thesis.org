...
| ~_command:~                                       |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# Read command argument./             |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~arg@t0 ← [INPUT@s0++];~               | ~lb t0,s0,0~          | {{{off(0x000)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(00101)}}} {{{op(0000011)}}}  |                |                |
| {{{i(1)}}}                                        | ~addi s0,s0,1~        | {{{imm(0x001)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}} {{{op(0010011)}}}  |                |                |
| {{{i(1)}}} /# Command type by argument:/          |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0bi00ccccc~: define;/            |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0b011ccccc~: compile;/           |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0b111ccccc~: execute./           |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~if arg@t0~ ~&~ ~0b01100000~ ~=~ ~0:~  | ~andi t1,t0,0x060~    | {{{imm(0x060)}}}                    {{{rs1(00101)}}} {{{fn3(111)}}} {{{rd(00110)}}} {{{op(0010011)}}}  |                |                |
| {{{i(2)}}}     /# _Define_ a new word./           |                       |                                                                                                        |                |                |
| {{{i(2)}}}     ~flag@a0 ← arg@t0;~                | ~or a0,t0,zero~       | {{{fn7(0000000)}}} {{{rs2(00000)}}} {{{rs1(00101)}}} {{{fn3(110)}}} {{{rd(01010)}}}  {{{op(0110011)}}} |                |                |
| {{{i(2)}}}     ~goto Head.~                       | ~beq t1,zero,+??~     | {{{off(bbbbbbb)}}} {{{rs2(00000)}}} {{{rs1(00110)}}} {{{fn3(000)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} |                |                |
...
| ~_find1:~                                         |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~chr@t1~ ~←~ ~arg@t0~ ~&~ ~0b0111111;~ | ~andi t1,t0,0x07F~    | {{{imm(0x07F)}}}                    {{{rs1(00101)}}} {{{fn3(111)}}} {{{rd(00110)}}} {{{op(0010011)}}}  |                |                |
| {{{i(1)}}} ~if chr@t1 = [xt@a0 + 17]:~            | ~lb t2,0x011(a0)~     | {{{off(0x011)}}}                    {{{rs1(01010)}}} {{{fn3(000)}}} {{{rd(00111)}}} {{{op(0000011)}}}  |                |                |
| {{{i(2)}}}     /# We found a word whose/          |                       |                                                                                                        |                |                |
| {{{i(2)}}}     /# name begins with ~chr~./        |                       |                                                                                                        |                |                |
| {{{i(2)}}}     ~goto _match.~                     | ~beq t1,t2,+??~       | {{{off(bbbbbbb)}}} {{{rs2(00111)}}} {{{rs1(00110)}}} {{{fn3(000)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} |                |                |
...
| ~_match:~                                         |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~if arg@t0 & 0b1000000 = 0:~           | ~andi t1,t0,0x080~    | {{{imm(0x080)}}}                    {{{rs1(00101)}}} {{{fn3(111)}}} {{{rd(00110)}}} {{{op(0010011)}}}  |                |                |
| {{{i(2)}}}     /# _Compile_./                     |                       |                                                                                                        |                |                |
| {{{i(2)}}}     ~goto COMPL.~                      | ~beq t1,zero,+??~     | {{{off(bbbbbbb)}}} {{{rs2(00000)}}} {{{rs1(00110)}}} {{{fn3(000)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} |                |                |
...
| ~t1 += 0x2B7;~  /# 00101 0110111./                                            | ~addi t1, t1, 0x2B7~ | {{{imm(0x2B7)}}}                    {{{rs1(00110)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                |                                 |
...
| ~t1 ← 0x280E7000;~  /# 00101 000 00001 1100111./                              | ~lui t1, 0x280E7~    | {{{imm(0x280E7)}}}                                                  {{{rd(00110)}}}  {{{op(0110111)}}} |                |                                 |
...
|                                                           |                         |          |                |                                         |
| /# 16-bit align ~OUTPUT~./                                |                         |          |                |                                         |
| ~OUTPUT@s1 += 0x0F;~                                      | addi s1, s1, 0x00F      |          | {{{addr(??)}}} | ~48 83~ {{{modrm(C7,11,000,111)}}} ~0F~ |
| ~OUTPUT@s1 &= 0xF0;~                                      | andi s1, s1, 0x0F0      |          |                | ~48 83~ {{{modrm(E7,11,100,111)}}} ~F0~ |
|                                                           |                         |          |                |                                         |
| /# Fill the new dictionary entry:/                        |                         |          |                |                                         |
|                                                           |                         |          |                |                                         |
| /# 1. Set the _link field_, then set/                     |                         |          |                |                                         |
| /#{{{c(3)}}}LATEST to the new entry./                     |                         |          |                |                                         |
| ~latest@t0 ← [LATEST];~  /# [VARS+40]./                   | ld t0, 40(s2)           |          |                | ~48 8B~ {{{modrm(0A,00,001,010)}}}      |
| ~[OUTPUT@s1+8] ← latest@t0;~                              | sd t0, 8(s1)            |          |                | ~48 89~ {{{modrm(4F,01,001,111)}}} ~08~ |
| ~[LATEST] ← OUTPUT@s1;~                                   | sd s1, 40(s2)           |          |                | ~48 89~ {{{modrm(3A,00,111,010)}}}      |
|                                                           |                         |          |                |                                         |
| /# 2. Set the _flag+length field_./                       |                         |          |                |                                         |
| ~[OUTPUT@s1+16] ← flag@a0;~                               | sb a0, 16(s1)           |          |                |                                         |
|                                                           |                         |          |                |                                         |
| /# 3. Extract name length from flag/                      |                         |          |                |                                         |
| /#{{{c(3)}}}and copy _name field_./                       |                         |          |                |                                         |
| ~length@t0 ← flag@a0 & 0x1F;~                             | andi t0, a0, 0x01F      |          |                | ~83~ {{{modrm(E1,11,100,001)}}} ~1F~    |
| ~copy      length@t0 bytes~                               |                         |          |                |                                         |
| {{{c(5)}}}​~from INPUT@s0~                                 |                         |          |                |                                         |
| {{{c(5)}}}​~to OUTPUT@s1;~                                 |                         |          |                | ~F3 A4~                                 |
...
| ~code@t0 ← [LATEST];~  /# [VARS+40]./                     | ld t0, 40(s2)           |          |                | ~48 8B~ {{{modrm(0A,00,001,010)}}}      |
| ~[code@t0] ← INPUT@s0;~                                   | sd s0, 0(t0)            |          |                | ~48 89~ {{{modrm(39,00,111,001)}}}      |
|                                                           |                         |          |                |                                         |
| /# 1-bit align ~INPUT~ as required/                       |                         |          |                |                                         |
| /# by the RISC-V specification [cite:@riscv_spec_vol_i]./ |                         |          |                |                                         |
| ~return.~  /# To interpreter loop./                       | jalr zero, 0(ra)        |          |                | ~C3~                                    |
