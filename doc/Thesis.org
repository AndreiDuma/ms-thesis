...
| /# Global variable ~INPUT~./  |                    |                                                                                        |                |               |
| /# TODO: replace ??.          |                    |                                                                                        |                |               |
| ~INPUT@s0 ← 0x010000??;~      | ~lui s0,0x01000~   | {{{imm(0x10000)}}}                                 {{{rd(01001)}}}   {{{op(0110111)}}} | {{{addr(78)}}} | ~37 04 00 01~ |
...
|                               |                    | ~37 04 00 01~                                                                          |                |               |
|                               | ~addi s0,s0,0x0??~ | {{{imm(0x0FF)}}}   {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}}   {{{op(0010011)}}} |                | ~13 04 ?4 0?~ |
| /# Global variable ~OUTPUT~./ |                    |                                                                                        |                |               |
...
| ~_bi:~                                            |                       |                                                                                                        | {{{addr(90)}}} |                |
| {{{i(1)}}} /# Loop the binary interpreter./       |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~call bi();~                           | ~jalr ra,8(zero)~     | {{{off(0x008)}}}                    {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00001)}}} {{{op(1101111)}}}  |                | ~DF 00 80 00~  |
| {{{i(1)}}} ~goto _bi.~                            | ~jalr zero,-8(zero)~  | {{{off(0xFF8)}}}                    {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00000)}}} {{{op(1101111)}}}  |                | ~6F 00 80 FF~  |
| ~bi():~                                           |                       |                                                                                                        | {{{addr(98)}}} |                |
| {{{i(1)}}} /# Read next byte from ~INPUT~./       |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~chr@t0 ← [INPUT@s0++];~               | ~lb t0,s0,0~          | {{{off(0x000)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(00101)}}} {{{op(0000011)}}}  |                | ~83 05 04 00~  |
| {{{i(1)}}}                                        | ~addi s0,s0,1~        | {{{imm(0x001)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}} {{{op(0010011)}}}  |                | ~13 04 14 00~  |
| {{{i(1)}}} /# Does it start a command?/           |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~if chr@t0 = 0x99:~                    | ~addi t1,zero,0x099~  | {{{imm(0x099)}}}                    {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                | ~93 02 90 09~  |
| {{{i(2)}}}     ~goto _command.~                   | ~beq t0,t1,+??~       | {{{off(bbbbbbb)}}} {{{rs2(00110)}}} {{{rs1(00101)}}} {{{fn3(000)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} |                |                |
| {{{i(1)}}} /# If not, just copy the byte/         |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# to ~OUTPUT~ and return./            |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~[OUTPUT@s1++] ← chr@t0;~              | ~sb t0,0(s1)~         | {{{off(???????)}}} {{{rs2(00101)}}} {{{rs1(01001)}}} {{{fn3(000)}}} {{{off(bbbbb)}}} {{{op(0100011)}}} |                |                |
| {{{i(1)}}}                                        | ~addi s1,s1,1~        | {{{imm(0x001)}}}                    {{{rs1(01001)}}} {{{fn3(000)}}} {{{rd(01001)}}} {{{op(0010011)}}}  |                |                |
| {{{i(1)}}} ~return.~                              | ~jalr zero,0(ra)~     | {{{off(0x000)}}}                    {{{rs1(00001)}}} {{{fn3(000)}}} {{{rd(00000)}}} {{{op(1101111)}}}  |                |                |
| ~_command:~                                       |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# Get latest dictionary word/         |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# from ~LATEST~ (~VARS + 40~):/       |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~xt@a0 ← [LATEST];~                    | ~ld a0,40(s2)~        | {{{off(0x028)}}}                    {{{rs1(01010)}}} {{{fn3(011)}}} {{{rd(01010)}}} {{{op(0000011)}}}  |                |                |
| {{{i(1)}}}                                        |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# Read command argument./             |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~arg@a1 ← [INPUT@s0++];~               | ~lb a1,s0,0~          | {{{off(0x000)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01011)}}} {{{op(0000011)}}}  |                |                |
| {{{i(1)}}}                                        | ~addi s0,s0,1~        | {{{imm(0x001)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}} {{{op(0010011)}}}  |                |                |
| {{{i(1)}}} /# Command type by argument:/          |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0bi00ccccc~: define;/            |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0b011ccccc~: compile;/           |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# – ~0b111ccccc~: execute./           |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~if arg@a1~ ~&~ ~0b01100000~ ~=~ ~0:~  | ~andi t0,a1,0x060~    | {{{imm(0x060)}}}                    {{{rs1(01011)}}} {{{fn3(111)}}} {{{rd(00101)}}} {{{op(0010011)}}}  |                |                |
| {{{i(2)}}}     /# _Define_ a new word./           |                       |                                                                                                        |                |                |
| {{{i(2)}}}     ~goto Head.~                       | ~beq t0,zero,+??~     | {{{off(bbbbbbb)}}} {{{rs2(00000)}}} {{{rs1(00101)}}} {{{fn3(000)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} |                |                |
| ~_find1:~                                         |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~chr@t0~ ~←~ ~arg@a1~ ~&~ ~0b0111111;~ | ~andi t0,a1,0x07F~    | {{{imm(0x07F)}}}                    {{{rs1(01011)}}} {{{fn3(111)}}} {{{rd(00101)}}} {{{op(0010011)}}}  |                |                |
| {{{i(1)}}} ~if chr@t0 = [xt@a0 + 17]:~            | ~lb t1,0x011(a0)~     | {{{off(0x011)}}}                    {{{rs1(01010)}}} {{{fn3(000)}}} {{{rd(00110)}}} {{{op(0000011)}}}  |                |                |
| {{{i(2)}}}     /# We found a word whose/          |                       |                                                                                                        |                |                |
| {{{i(2)}}}     /# name begins with ~chr~./        |                       |                                                                                                        |                |                |
| {{{i(2)}}}     ~goto _match.~                     | ~beq t0,t1,+??~       | {{{off(bbbbbbb)}}} {{{rs2(00110)}}} {{{rs1(00101)}}} {{{fn3(000)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} |                |                |
| {{{i(1)}}} /# Follow word's link pointer/         |                       |                                                                                                        |                |                |
| {{{i(1)}}} /# to previous entry and repeat./      |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~xt@a0 ← [xt@a0 + 8];~                 | ~ld a0,8(a0)~         | {{{off(0x008)}}}                    {{{rs1(01010)}}} {{{fn3(011)}}} {{{rd(01010)}}} {{{op(0000011)}}}  |                |                |
| {{{i(1)}}} ~goto _find1.~                         | ~jalr zero,-??(zero)~ | {{{off(0xhhh)}}}                    {{{rs1(00000)}}} {{{fn3(000)}}} {{{rd(00000)}}} {{{op(1101111)}}}  |                |                |
| ~_match:~                                         |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~if arg@a1 & 0b1000000 = 0:~           | ~andi t0,a1,0x080~    | {{{imm(0x080)}}}                    {{{rs1(01011)}}} {{{fn3(111)}}} {{{rd(00101)}}} {{{op(0010011)}}}  |                |                |
| {{{i(2)}}}     /# _Compile_./                     |                       |                                                                                                        |                |                |
| {{{i(2)}}}     ~goto COMPL.~                      | ~beq t0,zero,+??~     | {{{off(bbbbbbb)}}} {{{rs2(00000)}}} {{{rs1(00101)}}} {{{fn3(000)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} |                |                |
| {{{i(1)}}} /# _Execute_ word's code./             |                       |                                                                                                        |                |                |
| {{{i(1)}}} ~goto [xt@a0].~                        | ~ld t0,0(a0)~         | {{{off(0x000)}}}                    {{{rs1(01010)}}} {{{fn3(011)}}} {{{rd(00101)}}} {{{op(0000011)}}}  |                |                |
| {{{i(1)}}}                                        | ~jalr zero,0(t0)~     | {{{off(0x000)}}}                    {{{rs1(00101)}}} {{{fn3(000)}}} {{{rd(00000)}}} {{{op(1101111)}}}  |                |                |
|                                                   |                       |                                                                                                        | {{{addr(??)}}} |                |
...
| *Pseudocode*                                                                                   | *Instruction*        | *Encoding*                                                                                             | *&*            | *Machine code*                  |
|------------------------------------------------------------------------------------------------+----------------------+--------------------------------------------------------------------------------------------------------+----------------+---------------------------------|
| /# Define:/ _~COMPL~_                                                                          | ---                  | ---                                                                                                    | {{{addr(??)}}} | {{{define(99,43 4F 4D 50 4C)}}} |
| /# In/Out:/ ~( xt@a0 -- )~                                                                     |                      |                                                                                                        |                |                                 |
|                                                                                                |                      |                                                                                                        |                |                                 |
...
| ~t0 ← [xt@a0];~                                                                                | ~lw t0, 0(a0)~       | {{{off(0x000)}}}                    {{{rs1(01010)}}} {{{fn3(010)}}} {{{rd(00101)}}}  {{{op(0000011)}}} |                |                                 |
|                                                                                                |                      |                                                                                                        |                |                                 |
| /# 2. Assemble and write ~lui~ instr./                                                         |                      |                                                                                                        |                |                                 |
| ~t1 ← 0xFFFFF000;~                                                                             | ~lui t1, 0xFFFFF~    | {{{imm(0xFFFFF)}}}                                                  {{{rd(00110)}}}  {{{op(0110111)}}} |                |                                 |
| ~t1 &= t0;~                                                                                    | ~and t1, t1, t0~     | {{{fn7(0000000)}}} {{{rs2(00101)}}} {{{rs1(00110)}}} {{{fn3(111)}}} {{{rd(00110)}}}  {{{op(0110011)}}} |                |                                 |
| ~t1 += 0x2B7;~  /# 12 fixed bits in ~lui~./                                                    | ~addi t1, t1, 0x2B7~ | {{{imm(0x2B7)}}}                    {{{rs1(00110)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                |                                 |
| ~[OUTPUT@s1++4] ← t1;~                                                                         | ~sw t1, 0(s1)~       | {{{off(0000000)}}} {{{rs2(00110)}}} {{{rs1(01001)}}} {{{fn3(010)}}} {{{off(00000)}}} {{{op(0100011)}}} |                |                                 |
|                                                                                                | ~addi s1, s1, 4~     | {{{imm(0x004)}}}                    {{{rs1(00110)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                |                                 |
| /# 3. Assemble and write ~jalr~ instruction./                                                  |                      |                                                                                                        |                |                                 |
| ~t1 ← 0x280E7000;~  /# 20 fixed bits in ~jalr~./                                               |                      |                                                                                                        |                |                                 |
| ~t1 >>>= 12;~                                                                                  | ~srli t1, t1, 12~    | ~000000~ {{{shamt(001100)}}}        {{{rs1(00110)}}} {{{fn3(101)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                |                                 |
| ~t0 <<= 20;~                                                                                   | ~slli t0, t0, 20~    | ~000000~ {{{shamt(010100)}}}        {{{rs1(00101)}}} {{{fn3(101)}}} {{{rd(00101)}}}  {{{op(0010011)}}} |                |                                 |
| ~t1~ \vert​~= t0;~                                                                                  | ~or t1, t1, t0~      | {{{fn7(0000000)}}} {{{rs2(00101)}}} {{{rs1(00110)}}} {{{fn3(110)}}} {{{rd(00110)}}}  {{{op(0110011)}}} |                |                                 |
| ~[OUTPUT@s1++4] ← t1;~                                                                         | ~sw t1, 0(s1)~       | {{{off(0000000)}}} {{{rs2(00110)}}} {{{rs1(01001)}}} {{{fn3(010)}}} {{{off(00000)}}} {{{op(0100011)}}} |                |                                 |
|                                                                                                | ~addi s1, s1, 4~     | {{{imm(0x004)}}}                    {{{rs1(00110)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                |                                 |
| ~return.~  /# To interpreter loop./                                                            | ~jalr zero, 0(ra)~   | {{{off(0x000)}}}                    {{{rs1(00001)}}} {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1101111)}}} |                |                                 |
|                                                                                                |                      |                                                                                                        | {{{addr(??)}}} |                                 |
...
| *Pseudocode*                                                        | *Instruction*          | *Encoding*                                                                                             | *&*            | *Machine code*               |
|---------------------------------------------------------------------+------------------------+--------------------------------------------------------------------------------------------------------+----------------+------------------------------|
| /# Define:/ _~Head~_                                                | ---                    | ---                                                                                                    | {{{addr(??)}}} | {{{define(04,48 65 61 64)}}} |
| /# In/Out:/ ~( latest@a0~                                           |                        |                                                                                                        |                |                              |
| /#/{{{io}}}   ~flag@a1 -​- )~                                        |                        |                                                                                                        |                |                              |
|                                                                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# 16-bit align ~OUTPUT~./                                |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​~OUTPUT@s1 += 0x0F;~                                      | *addi* s1, s1, /0x00F/ | {{{imm(0x00F)}}}                    {{{rs1(01001)}}} {{{fn3(000)}}} {{{rd(01001)}}}  {{{op(0010011)}}} | {{{addr(??)}}} |                              |
| {{{c(2)}}}​~OUTPUT@s1 &= 0xF0;~                                      | *andi* s1, s1, /0x0F0/ | {{{imm(0x0F0)}}}                    {{{rs1(01001)}}} {{{fn3(111)}}} {{{rd(01001)}}}  {{{op(0010011)}}} |                |                              |
|                                                                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# New word starts here./                                 |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​~xt@t0 ← OUTPUT@s1;~                                      | *or* t0, s1, s1        | {{{fn7(0000000)}}} {{{rs2(01001)}}} {{{rs1(01001)}}} {{{fn3(110)}}} {{{rd(00101)}}}  {{{op(0110011)}}} |                |                              |
|                                                                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# Fill the new dictionary entry:/                        |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/#/                                                       |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# 1. Set the _link_ field, then point/                   |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# ~LATEST~ (~VARS+40~) to new word./                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​~[xt@t0 + 8] ← latest@a0;~                                | *sd* a0, _8_​(t0)       | {{{off(0000000)}}} {{{rs2(01011)}}} {{{rs1(00101)}}} {{{fn3(011)}}} {{{off(01000)}}} {{{op(0100011)}}} |                |                              |
| {{{c(2)}}}​~[LATEST] ← xt@t0;~                                       | *sd* t0, _40_​(s2)      | {{{off(0000001)}}} {{{rs2(00101)}}} {{{rs1(01010)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} |                |                              |
|                                                                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# 2. Set the _flag+length_ field./                       |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​~[xt@t0 + 16] ← flag@a1;~                                 | *sb* a1, _16_​(t0)      | {{{off(0000000)}}} {{{rs2(01011)}}} {{{rs1(00101)}}} {{{fn3(000)}}} {{{off(10000)}}} {{{op(0100011)}}} |                |                              |
|                                                                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# 3. Extract name length from/                           |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# ~flag~ and copy into _name_ field./                    |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​~length@t1 ← flag@a1 & 0x1F;~                             | *andi* t1, a1, /0x01F/ | {{{imm(0x01F)}}}                    {{{rs1(01011)}}} {{{fn3(111)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                |                              |
| {{{c(2)}}}​~OUTPUT@s1 ← xt@t0 + 17;~                                 | *addi* s1, t0, /0x011/ | {{{imm(0x011)}}}                    {{{rs1(00101)}}} {{{fn3(000)}}} {{{rd(01001)}}}  {{{op(0010011)}}} |                |                              |
| ~_begin:~                                                           |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​~chr@t2 ← [INPUT@s0++];~                                  | *lb* t2, _0_​(s0)       | {{{off(0x000)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(00111)}}}  {{{op(0000011)}}} |                |                              |
|                                                                     | *addi* s0, s0, /1/     | {{{imm(0x001)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}}  {{{op(0010011)}}} |                |                              |
| {{{c(2)}}}​~[OUTPUT@s1] ← chr@t2;~                                   | *sb* t2, _0_​(s1)       | {{{off(0000000)}}} {{{rs2(00111)}}} {{{rs1(01001)}}} {{{fn3(000)}}} {{{off(00000)}}} {{{op(0100011)}}} |                |                              |
|                                                                     | *addi* s1, s1, /1/     | {{{imm(0x001)}}}                    {{{rs1(01001)}}} {{{fn3(000)}}} {{{rd(01001)}}}  {{{op(0010011)}}} |                |                              |
| {{{c(2)}}}​~length@t1--;~                                            | *addi* t1, t1, /-1/    | {{{imm(0xFFF)}}}                    {{{rs1(00110)}}} {{{fn3(000)}}} {{{rd(00110)}}}  {{{op(0010011)}}} |                |                              |
| {{{c(2)}}}​~if length@t1 != 0:~                                      |                        |                                                                                                        |                |                              |
| {{{c(4)}}}​  ~goto _begin;~                                          | *bne* t1, zero, _-??_  | {{{off(bbbbbbb)}}} {{{rs2(00000)}}} {{{rs1(00110)}}} {{{fn3(001)}}} {{{off(bbbbb)}}} {{{op(1100011)}}} |                |                              |
|                                                                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# 4. Point _code_ field to the code/                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# that follows at ~INPUT~./                              |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​~[xt@t0 + 0] ← INPUT@s0;~                                 | *sd* s0, _0_​(t0)       | {{{off(0000000)}}} {{{rs2(01000)}}} {{{rs1(00101)}}} {{{fn3(011)}}} {{{off(00000)}}} {{{op(0100011)}}} |                |                              |
|                                                                     |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# 1-bit align ~INPUT~ as required/                       |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​/# by the RISC-V specification [cite:@riscv_spec_vol_i]./ |                        |                                                                                                        |                |                              |
| {{{c(2)}}}​~INPUT@s0 += 0x01;~                                       | *addi* s0, s0, /0x001/ | {{{imm(0x001)}}}                    {{{rs1(01000)}}} {{{fn3(000)}}} {{{rd(01000)}}}  {{{op(0010011)}}} |                |                              |
| {{{c(2)}}}​~INPUT@s0 &= 0xFE;~                                       | *andi* s0, s0, /0x0FE/ | {{{imm(0x0FE)}}}                    {{{rs1(01000)}}} {{{fn3(111)}}} {{{rd(01000)}}}  {{{op(0010011)}}} |                |                              |
| {{{c(2)}}}​~return.~  /# To interpreter loop./                       | *jalr* zero, _0_​(ra)   | {{{off(0x000)}}}                    {{{rs1(00001)}}} {{{fn3(000)}}} {{{rd(00000)}}}  {{{op(1101111)}}} |                |                              |
...
|-------------------------+--------+--------------------------------------------------------------------------------------------------------+---------------------------------------------------------------|
| jal  rd, offset         | J      | TODO: remove?                                                                                          | ~offset[20\vert10:1\vert11\vert19:12]            rd              1101111~ |
| jalr rd, offset(rs1)    | I      | {{{off(0xhhh)}}}                    {{{rs1(rrrrr)}}} {{{fn3(000)}}} {{{rd(rrrrr)}}}  {{{op(1101111)}}} | ~offset[11:0]            rs1    000  rd              1100111~ |
|-------------------------+--------+--------------------------------------------------------------------------------------------------------+---------------------------------------------------------------|
| ecall                   | I      | ~000000000000~     ~00000~                           {{{fn3(000)}}} ~00000~          {{{op(0000011)}}} | ~000000000000            00000  000  00000           1110011~ |
|-------------------------+--------+--------------------------------------------------------------------------------------------------------+---------------------------------------------------------------|
