...
| {{{i(1)}}} /# {{{i(2.35)}}} ~TIB~ is ~VARS+8~,/  |                     |                                                                                                        |                |                                    |
| {{{i(1)}}} /# {{{i(2.35)}}} ~>IN~ is ~VARS+16~./ |                     |                                                                                                        |                |                                    |
| {{{i(1)}}} ~#in@t0 ← [#IN];~                     | ld t0, 0(s2)        |                                                                                                        |                | ~83 32 09 00~                      |
| {{{i(1)}}} ~tib@t1 ← [TIB] + #in@t0;~            | ld t1, 8(s2)        |                                                                                                        |                | ~03 33 89 00~                      |
...
| {{{i(1)}}} ~return.~                             | jalr zero, 0(ra)    |                                                                                                        |                | ~67 80 00 00~                      |
...
|                                                  |                   |            |                |                              |
| {{{c(2)}}} ~eof@t5 ← 0;~                         | addi t5, zero, 0  |            |                | ~13 0f 00 00~                |
| {{{c(2)}}} ~high'@a1 ← high@a1~                  |                   |            |                |                              |
| {{{c(11)}}}         ~- low@a0;~                  | sub a1, a1, a0    |            |                | ~b3 85 a5 40~                |
| {{{c(2)}}} ~>in@t2 ← [>IN];~                     | ld t2, 16(s2)     |            |                | ~83 33 09 01~                |
| {{{c(2)}}} ~#in@t0 ← [#IN];~                     | ld t0, 0(s2)      |            |                | ~83 32 09 00~                |
| ~_begin:~                                        |                   |            | {{{addr(00)}}} |                              |
| {{{c(2)}}} /# Is parse area empty?/              |                   |            |                |                              |
| {{{c(2)}}} ~if >in@t2~ \ge{{{unsigned}}} ~#in@t0:~ |                   |            |                |                              |
| {{{c(4)}}}   ~goto _end_eof.~                    | bgeu t2, t0, 0x20 |            |                | ~63 f0 53 02~                |
| {{{c(2)}}} /# Get current character./            |                   |            |                |                              |
| {{{c(2)}}} ~tib@t1 ← [TIB];~                     | ld t1, 8(s2)      |            |                | ~03 33 89 00~                |
| {{{c(2)}}} ~chr@t3 ← [tib@t1~                    |                   |            |                |                              |
| {{{c(10)}}}        ~+ >in@t2];~                  | add t4, t1, t2    |            |                | ~b3 0e 73 00~                |
| {{{c(2)}}}                                       | lbu t3, 0(t4)     |            |                | ~03 ce 0e 00~                |
| {{{c(2)}}} /# Is ~chr~ in ~[low, high)~?/        |                   |            |                |                              |
| {{{c(2)}}} ~chr'@t3 ← chr@t3~                    |                   |            |                |                              |
| {{{c(10)}}}        ~- low@a0;~                   | sub t3, t3, a0    |            |                | ~33 0e ae 40~                |
| {{{c(2)}}} ~if t3~ \lt{{{unsigned}}} ~high'@a1:~   |                   |            |                |                              |
| {{{c(4)}}}   ~goto _end.~                        | bltu t3, a1, 0x10 |            | {{{addr(14)}}} | ~63 68 be 00~                |
| {{{c(2)}}} /# Go to next character./             |                   |            |                |                              |
| {{{c(2)}}} ~>in@t2++;~                           | addi t2, t2, 1    |            |                | ~93 83 13 00~                |
| {{{c(2)}}} ~goto _begin.~                        | jal zero, 0xFE4   |            | {{{addr(1C)}}} | ~6f f0 5f fe~                |
| ~_end_eof:~                                      |                   |            | {{{addr(20)}}} |                              |
| {{{c(2)}}} ~eof@t5 ← 1;~                         | addi t5, zero, 1  |            |                | ~13 0f 10 00~                |
| ~_end:~                                          |                   |            | {{{addr(24)}}} |                              |
| {{{c(2)}}} ~[>IN] ← >in@t2;~                     | sd t2, 16(s2)     |            |                | ~23 38 79 00~                |
| {{{c(2)}}} ~eof@a0 ← eof@t5;~                    | addi a0, t5, 0    |            |                | ~13 05 0f 00~                |
| {{{c(2)}}} ~return.~                             | jalr zero, 0(ra)  |            |                | ~67 80 00 00~                |
...
| /# address and length./                         |                  |            |                |                                 |
|                                                 |                  |            |                |                                 |
| {{{c( 2)}}} ~push ra;~                          | addi sp, sp, -16 |            |                | ~13 01 01 ff~                   |
| {{{c( 2)}}}                                     | sd ra, 8(sp)     |            |                | ~23 34 11 00~                   |
| {{{c( 2)}}} ~start@t0 ← [>IN];~                 | ld t0, 16(s2)    |            |                | ~83 32 09 01~                   |
| {{{c( 2)}}} ~push start@t0;~                    | sd t0, 0(sp)     |            |                | ~23 30 51 00~                   |
| {{{c( 2)}}} /# Compile a call to ~seek~/        |                  |            |                |                                 |
| {{{c( 2)}}} /# that advances ~>IN~./            |                  |            |                |                                 |
| {{{c( 2)}}} ~call seek;~  /# Compiled./         | ---              | ---        |                | {{{compile(73,s)}}}             |
| {{{c( 2)}}} ~end@t1 ← [>IN];~                   | ld t1, 16(s2)    |            |                | ~03 33 09 01~                   |
| {{{c( 2)}}} ~restore start@t0;~                 | ld t0, 0(sp)     |            |                | ~83 32 01 00~                   |
| {{{c( 2)}}} /# Did ~seek()~ encounter the/      |                  |            |                |                                 |
| {{{c( 2)}}} /# end of the parse area?/          |                  |            |                |                                 |
| {{{c( 2)}}} ~if eof@a0 != 0:~                   |                  |            |                |                                 |
| {{{c( 4)}}}   ~goto _end.~                      | bne t0, zero, 12 |            | {{{addr(00)}}} | ~63 96 02 00~                   |
| {{{c( 2)}}} /# A character in range/            |                  |            |                |                                 |
| {{{c( 2)}}} /# ~[low, high)~ was found./        |                  |            |                |                                 |
| {{{c( 2)}}} ~[>IN]++;~  /# Skip it./            | addi t2, t1, 1   |            |                | ~93 03 13 00~                   |
| {{{c( 2)}}}                                     | sd t2, 16(s2)    |            |                | ~23 38 79 00~                   |
| ~_end:~                                         |                  |            | {{{addr(0C)}}} |                                 |
| {{{c( 2)}}} /# Compute address and/             |                  |            |                |                                 |
| {{{c( 2)}}} /# length of parsed input./         |                  |            |                |                                 |
| {{{c( 2)}}} ~addr@a0 ← [TIB]~                   | ld t2, 8(s2)     |            |                | ~83 33 89 00~                   |
| {{{c(10)}}}         ~+ start@t0;~               | add a0, t2, t0   |            |                | ~33 85 53 00~                   |
| {{{c( 2)}}} ~u@a0~ ~←~ ~end@t1~ ~-~ ~start@t0;~ | sub a1, t1, t0   |            |                | ~b3 05 53 40~                   |
| {{{c( 2)}}} ~pop ra;~                           | ld ra, 8(sp)     |            |                | ~83 30 81 00~                   |
| {{{c( 2)}}}                                     | addi sp, sp, 16  |            |                | ~13 01 01 01~                   |
| {{{c( 2)}}} ~return.~                           | jalr zero, 0(ra) |            |                | ~67 80 00 00~                   |
...
| /# parse the word itself./         |                      |            |                                 |
|                                    |                      |            |                                 |
| ~push ra;~                         | addi sp, sp, -8      |            | ~13 01 81 ff~                   |
|                                    | sd ra, 0(sp)         |            | ~23 30 11 00~                   |
| /# Skip non-printables./           |                      |            |                                 |
| ~low@a0 ← 0x21;~   /# Char ~'!'~./ | addi a0, zero, 0x021 |            | ~13 05 10 02~                   |
| ~high@a1 ← 0x7F;~  /# Char ~DEL~./ | addi a1, zero, 0x07F |            | ~93 05 f0 07~                   |
| ~call seek;~  /# Compiled./        | ---                  | ---        | {{{compile(73,s)}}}             |
| /# Parse token, stopping at first/ |                      |            |                                 |
| /# non-printable character./       |                      |            |                                 |
| ~low@a0 ← 0x7F;~                   | addi a0, zero, 0x7F  |            | ~13 05 f0 07~                   |
| ~high@a1 ← 0x21;~                  | addi a1, zero, 0x21  |            | ~93 05 10 02~                   |
| ~call PARSE;~  /# Compiled./       | ---                  | ---        | {{{compile(50,P)}}}             |
| ~pop ra;~                          | ld ra, 0(sp)         |            | ~83 30 01 00~                   |
|                                    | addi sp, sp, 8       |            | ~13 01 81 00~                   |
| ~return.~                          | jalr zero, 0(ra)     |            | ~67 80 00 00~                   |
