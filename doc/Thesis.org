...
#
# Set a different page layout with:
...
# --- Source block macros.
#+MACRO: src      \fontsize{$1}{10pt}\selectfont
#+MACRO: encsrc   \fontsize{10pt}{12pt}\selectfont
...
# --- Table macros.
#+MACRO: table      \vspace{1.5em} \begin{table}[htbp] \begin{adjustwidth}{-10em}{-10em}
#+MACRO: endtable   \end{adjustwidth} \end{table} \vspace{-0.5em}
